...
public class Config : MonoBehaviour
{
    ...
    public static float BOTTOM = -10f;  // Simulation space ground
    public static float DAM = -0.3f;  // Position of the dam, simulation space is between -0.5 and 0.5
    public static int DAM_BREAK = 2000; // Number of frames before the dam breaks
    ...
    public static float R = SPACING * .25f;
    ...
    public static float WALL_DAMP = 0.5f;
